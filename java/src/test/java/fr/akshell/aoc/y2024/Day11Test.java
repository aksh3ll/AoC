...
class Day11Test extends BaseTest<Long> {
    ...
    void givenAStone_whenApplyingRules_thenIGetAListOfStones() {
        ...
        assertThat(day11.applyRules(0)).isEqualTo(List.of(1L));
        assertThat(day11.applyRules(1)).isEqualTo(List.of(2024L));
        assertThat(day11.applyRules(10)).isEqualTo(List.of(1L, 0L));
        assertThat(day11.applyRules(11)).isEqualTo(List.of(1L, 1L));
        assertThat(((Day11) getDay()).applyRules(3)).isEqualTo(List.of(3 * 2024L));
    }
    ...
    void givenAStone_whenApplyingRules2_thenIGetTheTotalOfStones() {
        Day11 day11 = (Day11) getDay();
        assertThat(day11.applyRules2(0, 0)).isEqualTo(1);
        assertThat(day11.applyRules2(0, 1)).isEqualTo(1);
        assertThat(day11.applyRules2(1, 1)).isEqualTo(1);
        assertThat(day11.applyRules2(10, 1)).isEqualTo(2);
        assertThat(day11.applyRules2(10, 2)).isEqualTo(2);
        assertThat(day11.applyRules2(10, 3)).isEqualTo(3);
    }
